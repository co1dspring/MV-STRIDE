...
def plot_training_logs(jsonl_path):
    ...
    if 'completions/mean_length' in df.columns:
        # Create a group marker, one group per 50 rows
    ...
    # --- Figure 4: LR & Grad Norm (key update) ---
    ax4 = axes[1, 0]
    ...
    # --- Figure 5: Entropy & Reward Std (key update) ---
    ax5 = axes[1, 1]
    ...
    # Add Std monitoring for each reward item
    ax5_twin = ax5.twinx()
    std_keys = {
...
if __name__ == "__main__":
    ...
    # LOG_FILE = r"/path/to/data/logging.jsonl"
    LOG_FILE = r"/path/to/data/logging.jsonl"
