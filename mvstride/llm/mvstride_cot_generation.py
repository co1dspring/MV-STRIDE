...
def main():
    ...
    for json_file in tqdm(json_list):
        ...
        output_jsonl_file = os.path.join(output_dir, f"{os.path.splitext(json_file)[0]}_answer_4o.jsonl")
...
class APIDataProcesser:
    ...
    def _format_user_prompt(self, item):
        """Convert the multi-turn Level 1-3 dialogue into a reasoning prompt."""
        user_prompt = ""
